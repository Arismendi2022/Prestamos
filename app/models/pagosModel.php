<?php
	...
	class PagosModel extends Mysql
	{
		...
		{
			$sql = "SELECT idpago, CONCAT(nombres, ' ', apellidos) as nombre,RIGHT(REPLICATE('0', 6) + CONVERT(VARCHAR(6), prestamoid), 6) AS prestamoid,FORMAT(fecha_pago, 'dd-MM-yyyy') as fecha_pago,monto_pagado,cuota_pagada FROM tbl_pagos
